...
//TODO:
//Implement Preprocessor definitions on project
//XXX - Start PP Defs
/*
BUGTRAK = 
EDITOR=  
...
//XXX Builds
//             target  master  flavor  skup     release
//dromed.exe:  build   opt     editprof y        y
//ddromed.exe: build   dbg     editor   y        y       (rename to dbgdrom.exe/pdb)
//dbgdark:     dark    dbg     dbg      n        y       <-- rename dbgthief
//optdark:     dark    opt     opt      n        y       <-- playtester's build until mid-october, rename thief
//shpdark:     dark    shp     shp      n        y       <-- playtest after mid-october, rename shpthief
